...
class WordAnalyze:
    ...
    """
     Don't forget that words like 'very' , 'angrily' ..., are 
     stemmed to 'veri','angrili'
    ...
    def words_filter(self):
        ...
        """
        As of now , there are about 60 prepositions in the file . You can add 
        more prepositions to the 'prepositions.csv' file
